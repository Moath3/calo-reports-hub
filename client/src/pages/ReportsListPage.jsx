...
export default function ReportsListPage() {
  ...
  useEffect(() => { fetchReports(1); }, [statusFilter]);
    ...
    <div className="space-y-5 animate-in">
      ...
      {loading ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {reports.map(r => (
            <div key={r.id} className="card-hover p-5 flex flex-col" onClick={() => navigate(`/reports/${r.id}`)}>
        ...
        <div className="card p-12 text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">Create your first report to get started</p>
